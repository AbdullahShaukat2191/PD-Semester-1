...
void howToPlay()
{
    ...
    cout << " _                     _                _             " << endl;
    gotoxy(50, 4);
    cout << "| |__   _____      __ | |_ ___    _ __ | | __ _ _   _ " << endl;
    gotoxy(50, 5);
    cout << "| '_ \\ / _ \\ \\ /\\ / / | __/ _ \\  | '_ \\| |/ _` | | | |" << endl;
    gotoxy(50, 6);
    cout << "| | | | (_) \\ V  V /  | || (_) | | |_) | | (_| | |_| |" << endl;
    gotoxy(50, 7);
    cout << "|_| |_|\\___/ \\_/\\_/    \\__\\___/  | .__/|_|\\__,_|\\__, |" << endl;
    gotoxy(50, 8);
    cout << "                                 |_|            |___/ " << endl;
    gotoxy(10, 9);
    cout << "==============================================================================================================================================" << endl;
    ...
    cout << "<--------------------------------ENEMIES-------------------------------->";
    gotoxy(40, 12);
    cout << "ENEMY TYPE 1:                                            ENEMY TYPE 2:";
    gotoxy(40, 14);
    cout << "  //-||-||-/                                               //-||-||-/";
    gotoxy(35, 15);
    cout << "1.   <  <HUNK> <                                         2.   <  <KILL> < ";
    ...
    cout << "  \\\\-||-||-\\                                               \\\\-||-||-\\";
    gotoxy(40, 18);
    cout << "--The HUNK--                                            --The SHOOTER--";
    gotoxy(38, 20);
    cout << "<------------------------------INSTRUCTIONS----------------------------->";
    gotoxy(35, 22);
    cout << "1. Use the ARROW KEYS to Control Iron-Man's SpaceShip !";
    gotoxy(35, 23);
    cout << "2. Use the SPACEBAR to fire Iron-Man's Repulsor Beams to take out ULTRON'S Minions.";
    gotoxy(35, 24);
    cout << "3. Beware as The SHOOTER'S HOMING MISSILES are Un-dodgeable.";
    gotoxy(35, 25);
    cout << "4. The HUNK doesn't shoot, but one collision with him will result in an INSTANT GAME OVER !";
    gotoxy(35, 26);
    cout << "5. Collect ENERY CORES ($) to increase your Score.";
    gotoxy(35, 27);
    cout << "6. Defeating ULTRON'S Minions give you BACK ONE LIFE !";
    gotoxy(35, 28);
    cout << "7. You have 3 LIVES, so be Cautious !";
    gotoxy(35, 29);
    cout << "8. Have Fun !";
    gotoxy(35, 31);
