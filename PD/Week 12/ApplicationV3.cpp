...
int userCount = 5;
string users[ArraySize] = {"Faizan","Ahmed","Abdullah","Usman","Ayesha"};
string passwords[ArraySize]= {"2191","1234","3670","9962","L1F1"};
string role[ArraySize] = {"user","user","user","user","user"};

string ProductName[ArraySize] = {"Boys Jeans","Girls Tights","Boys Jacket","Girls Frock","Girls Shoes"};
int ProductPrice[ArraySize] = {350,200,1400,800,400};
int ProductQuantity[ArraySize] = {37,44,21,28,9};
int ProductTax[ArraySize] = {10,7,15,8,10};
    ...
    while(LoginOption != "3")
    {
        ...
        if (LoginOption == "1")
        {
            ...
            if (addUser(newName, newPassword)) {
                ...
                cout << "Ensure that Username is Unique and Valid";
            }
        }
...
string LoginPage()
{
    ...
    cout << "How May we help you Today ? " << endl << endl;
...
string UserMenu(string name)
{
    ...
    cout << "What Are You Looking to Do ? " << endl << endl;
...
void Catalogue()
{
    ...
    Header();
    SubHeader();
    cout << "Catalogue: " << endl << endl;
    cout << "                   -Available Products-" << endl << endl;
    cout << " Product Name: \t Price:  In Stock: " << endl << endl;
...
void ShowUsers()
{
    ...
    cout << "Current Users: " << endl << endl;
    cout << " User Name: \t Passwords:    Role: " << endl << endl;
...
void UpdateStock()
{
    ...
    Header();
    SubHeader();
    cout << "Stock Update Menu:" << endl << endl;
    string option;
    cout << "                   -Available Products-" << endl << endl;
    cout << " Product Name: \t Price:  In Stock: " << endl << endl;
...
void DeleteStock()
{
    ...
    Header();
    SubHeader();
    cout << "Stock Delete Menu:" << endl << endl;
    string option;
    cout << "                   -Available Products-" << endl << endl;
    cout << " Product Name: \t Price:  In Stock: " << endl << endl;
...
void SubHeader() {
cout << "Welcome to Veezo Verpali, Pakistan's Largest Children's Garments Store." << endl << endl;
}